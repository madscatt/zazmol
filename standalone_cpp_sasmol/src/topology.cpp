...
const CharmmNameTable& charmm_names() {
  static const CharmmNameTable names = {
      {"hydrogen",
       {"HN", "HA", "HB1", "HB2", "HB3", "HG1", "HG2", "HD1",
        "HD2", "HE", "HH11", "HH12", "HH21", "HH22", "HD21", "HD22",
        "HE21", "HE22", "HA1", "HA2", "HE1", "HE2", "HB", "HG21",
        "HG22", "HG23", "HG11", "HG12", "HD3", "HG", "HD11", "HD12",
        "HD13", "HD23", "HZ1", "HZ2", "HZ3", "HE3", "HZ", "HH2",
        "HH", "HG13", "H1", "H2", "HC", "HD", "HMA1", "HMA2",
        "HMA3", "HAA1", "HAA2", "HBA1", "HBA2", "HMB1", "HMB2",
        "HMB3", "HAB", "HBB1", "HBB2", "HMC1", "HMC2", "HMC3", "HAC",
        "HBC1", "HBC2", "HMD1", "HMD2", "HMD3", "HAD1", "HAD2",
        "HBD1", "HBD2", "HT1", "HT2", "HT3", "HN1", "HN2", "HY1",
        "HY2", "HY3", "HNT", "H5'", "H5''", "H4'", "H1'", "H21",
        "H22", "H8", "H2''", "H2'", "H3'", "H61", "H62", "H6", "H5",
        "H41", "H42", "H3", "H51", "H52", "H53", "H11", "H12",
        "H13", "H23", "H9", "H5T", "H53'", "H5T1", "H5T2", "H5T3",
        "H3T", "H3T1", "H3T2", "H3T3", "H91", "H92", "H93", "H9B1",
        "H9B2", "H9B3", "H5M1", "H5M2", "H5M3", "H4", "H15", "H16",
        "H17", "H11'", "H12'", "H21'", "H22'", "H31'", "H32'", "H41'",
        "H42'", "H51'", "H52'", "H1''", "H4''", "H3''", "1H3'",
        "1H3''", "1H2''", "2H5'", "2H5''", "AH4'", "AH1'", "AH8",
        "AH2", "AH2'", "AH61", "AH62", "AH2T", "AH3'", "AH3T",
        "AH5'", "AH5S"}},
      {"carbon",
       {"CA", "CB", "C", "CG", "CD", "CZ", "CE1", "CD2", "CG2",
        "CG1", "CD1", "CE", "CE2", "CE3", "CZ3", "CZ2", "CH2", "C1A",
        "C2A", "C3A", "C4A", "C1B", "C2B", "C3B", "C4B", "C1C",
        "C2C", "C3C", "C4C", "C1D", "C2D", "C3D", "C4D", "CHA",
        "CHB", "CHC", "CHD", "CMA", "CAA", "CBA", "CGA", "CMB", "CAB",
        "CBB", "CMC", "CAC", "CBC", "CMD", "CAD", "CBD", "CGD", "CAY",
        "CY", "CT", "CAT", "C5'", "C4'", "C1'", "C4", "C2", "C6", "C5",
        "C8", "C2'", "C3'", "C5M", "C1", "C5T", "C3T", "C9", "C9B",
        "C3", "C7", "C10", "C12", "1CB", "2CB", "1C3'", "1C2'",
        "2C5'", "AC4'", "AC1'", "AC5", "AC8", "AC2", "AC4", "AC6",
        "AC2'", "AC3'", "AC5'"}},
      {"nitrogen",
       {"N", "NH1", "NH2", "ND2", "NE2", "ND1", "NZ", "NE1", "NA",
        "NB", "NC", "ND", "NT", "N9", "N2", "N3", "N1", "N7", "N6",
        "N4", "N14", "NP", "NO1", "NO2", "NO5'", "NC5'", "NH5S",
        "NH5'", "NC2'", "NH2'", "NO2'", "NH2T", "NC3'", "NH3'", "NO3'",
        "NH3T", "NC1'", "NH1'", "NC4'", "NH4'", "NO4'", "NN1", "NC6",
        "NH6", "NC5", "NH5", "NC4", "NH4", "NC3", "NC2", "NC7", "NO7",
        "NN7", "NH71", "NH72", "NH42", "AN7", "AN9", "AN1", "AN3",
        "AN6"}},
      {"oxygen",
       {"O", "OD1", "OD2", "OE1", "OE2", "OG", "OG1", "OH", "OH2",
        "O1A", "O2A", "O1D", "O2D", "OY", "OT1", "OT2", "O1", "O2",
        "O3", "O4", "O1P", "O2P", "O5'", "O4'", "O6", "O2'", "O3'",
        "O5T", "O1P3", "O2P3", "O3T", "O3P3", "O13", "O11", "O12",
        "O14", "O22", "O23", "O24", "O3A", "O1B", "O2B", "O3B",
        "O1G", "O2G", "O3G", "O21", "O3P", "O31P", "O32P", "O33P",
        "1O2'", "2O1P", "2O2P", "2O5'", "AO4'", "AO2'", "AO3'", "AO1",
        "AO2", "AO5'", "AO1P", "AO2P", "AO2T", "OM"}},
      {"sulfur", {"SG", "SD", "1SG", "2SG"}},
      {"phosphorus",
       {"P1", "P", "P3", "P2", "PA", "PB", "PG", "2P", "AP", "AP2"}},
      {"other",
       {"AS", "AG", "AL", "AR", "AC", "AT", "AU", "BI", "BE", "B",
        "BR", "BA", "CR", "CS", "CU", "CO", "D", "DY", "EU", "ER", "F",
        "FE", "FR", "GA", "GE", "GD", "HO", "HF", "IN", "I", "IR", "K",
        "KR", "LI", "LA", "LU", "MG", "MN", "MO", "NE", "NI", "OS",
        "PD", "PR", "PM", "PT", "PO", "RB", "RU", "RH", "RE", "RN",
        "RA", "SI", "SC", "SE", "SR", "SN", "SB", "SM", "TI", "TC",
        "TE", "TB", "TA", "TL", "TH", "U", "V", "W", "XE", "Y", "YB",
        "ZN", "ZR", "SS", "CAL", "DUM", "POT", "CES", "CLA"}},
  };
  return names;
}
