...
| DCD I/O | `DcdReader` / `DcdWriter` | required | Sequential, single-step reopen/scan, and whole-file read implemented for normal full-coordinate small fixtures; writer deferred. |
