...
| calculations | free functions / module namespaces | required | Coordinate bounds, mass, center-of-mass, radius-of-gyration, and RMSD slices implemented; PMI and alignment-dependent calculations remain deferred. |
