...
| DCD I/O | `DcdReader` / `DcdWriter` | required | Reader implemented for normal full-coordinate small fixtures; writer round-trips through C++ reader for `1ATM`, `2AAD`, and `rna-1to10`. |
