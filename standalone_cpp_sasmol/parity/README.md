...
| calculations | free functions / module namespaces | required | Coordinate bounds and mass slices implemented; COM/Rg/PMI and alignment-dependent calculations remain deferred. |
