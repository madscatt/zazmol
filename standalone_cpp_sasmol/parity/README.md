...
| DCD I/O | `DcdReader` / `DcdWriter` | required | Sequential read and single-step reopen/scan implemented for normal full-coordinate small fixtures; writer deferred. |
