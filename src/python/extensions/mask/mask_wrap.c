...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_get_mask_array(PyObject *self, PyObject *args) {
  ...
  (void)self;
  if (!SWIG_Python_UnpackTuple(args, "get_mask_array", 6, 6, swig_obj)) SWIG_fail;
  {
    array1 = obj_to_array_no_conversion(swig_obj[0], NPY_LONGLONG);
...
static PyMethodDef SwigMethods[] = {
	 { "get_mask_array", _wrap_get_mask_array, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
