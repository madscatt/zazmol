...
class SasAtm(sasio.Files, calculate.Calculate, operate.Move, sassubset.Mask, sasproperties.Atomic, topology.CharmmTopology, view.View):
...
class SasAss(SasMol):
    ...
    '''
# DONE    Ans: Yes. If SasAss can be loaded directly (i.e. with SasMol)
# does it inherit from SasAtm?
...
class SasSys():
    ...
    Usage:
        ...
        a=sasmol.SasSys(id,systype='atomic') 	# creates an atomic object; system will only contain atomic objects
        a=sasmol.SasSys(id,systype='solid') 	# creates a solid type; system will ONLY contain solid objects
