...
class Test_linear_algebra_matrix_multiply(unittest.TestCase):
    ...
    def test_arb_1(self):
        ...
        expected = numpy.array(
            [[-1585.84, -140.0], [-24.5454, -880.8]], floattype)
        self.assert_list_almost_equal(result, expected)
        result_error = linear_algebra.matrix_multiply(a, b)[0]
        expected_error = []
        self.assertEqual(result_error, expected_error)
    ...
    def test_inf_1(self):
        a = numpy.array([[util.HUGE, -20.0, 80.0],
                        [2.02, util.HUGE, 20.0]], floattype)
        b = numpy.array(
            [[1.23, 2.0, 20.0], [10.0, 21.0, util.HUGE]], floattype).T
        result = linear_algebra.matrix_multiply(a, b)[1]
        expected = numpy.array(
            [[util.INF, util.INF], [util.INF, util.INF]], floattype)
        self.assert_list_almost_equal(result, expected)
        result_error = linear_algebra.matrix_multiply(a, b)[0]
        expected_error = []
        self.assertEqual(result_error, expected_error)
    ...
    def test_inf_2(self):
        a = numpy.array(
            [[util.INF, -20.0, 80.0], [2.02, util.INF, 20.0]], floattype)
        b = numpy.array(
            [[1.23, 2.0, 20.0], [10.0, 21.0, util.INF]], floattype).T
        result = linear_algebra.matrix_multiply(a, b)[1]
        expected = numpy.array(
            [[util.INF, util.INF], [util.INF, util.INF]], floattype)
        self.assert_list_almost_equal(result, expected)
    ...
    def test_nan(self):
        a = numpy.array(
            [[util.NAN, -20.0, 80.0], [2.02, util.NAN, 20.0]], floattype)
        b = numpy.array(
            [[1.23, 2.0, 20.0], [10.0, 21.0, util.NAN]], floattype).T
        result = linear_algebra.matrix_multiply(a, b)[1]
        expected = numpy.array(
            [[util.NAN, util.NAN], [util.NAN, util.NAN]], floattype)
        self.assert_list_almost_equal(result, expected)
        result_error = linear_algebra.matrix_multiply(a, b)[0]
        expected_error = []
        self.assertEqual(result_error, expected_error)
    ...
    def test_nan_inf(self):
        a = numpy.array(
            [[util.INF, -20.0, 80.0], [2.02, util.NAN, 20.0]], floattype)
        b = numpy.array(
            [[1.23, 2.0, 20.0], [10.0, 21.0, util.NAN]], floattype).T
        result = linear_algebra.matrix_multiply(a, b)[1]
        expected = numpy.array(
            [[util.INF, util.NAN], [util.NAN, util.NAN]], floattype)
        self.assert_list_almost_equal(result, expected)
        result_error = linear_algebra.matrix_multiply(a, b)[0]
        expected_error = []
        self.assertEqual(result_error, expected_error)
    ...
    def test_tiny(self):
        a = numpy.array([[util.TINY, -20.0, 80.0],
                        [2.02, util.TINY, 20.0]], floattype)
        b = numpy.array(
            [[1.23, 2.0, 20.0], [10.0, 21.0, util.TINY]], floattype).T
        result = linear_algebra.matrix_multiply(a, b)[1]
    ...
    def test_zero(self):
        a = numpy.array([[util.ZERO, -20.0, 80.0],
                        [2.02, util.ZERO, 20.0]], floattype)
        b = numpy.array(
            [[1.23, 2.0, 20.0], [10.0, 21.0, util.ZERO]], floattype).T
        result = linear_algebra.matrix_multiply(a, b)[1]
        expected = numpy.array([[1560.0, -420.0], [402.4846, 20.2]], floattype)
        self.assert_list_almost_equal(result, expected)
        result_error = linear_algebra.matrix_multiply(a, b)[0]
