...
class Test_intg_sasio_Files_initialize_children(unittest.TestCase):
    ...
    def test_1ATM(self):
        ...
        self.assertEqual([item.name()
                         for item in self.o.init_child('names')], [['N']])
        self.assertEqual([item.resname()
                         for item in self.o.init_child('resnames')], [['ILE']])
        self.assertEqual([item.resid()
                         for item in self.o.init_child('resids')], [[515]])
        self.assertEqual([item.chain()
                         for item in self.o.init_child('chains')], [['N']])
        self.assertEqual([item.occupancy()
                         for item in self.o.init_child('occupancies')], [['1.00']])
        self.assertEqual([item.beta()
                         for item in self.o.init_child('betas')], [['36.37']])
        # self.assertEqual([item.segname() for item in self.o.init_child('segnames')],[['DUM0']])
        self.assertEqual([item.segname()
                         for item in self.o.init_child('segnames')], [['N']])
        self.assertEqual([item.element()
                         for item in self.o.init_child('elements')], [['N']])
    ...
    def test_2AAD_names(self):
        ...
        # print('result \n',result)
        #
        expected = [['N', 'N'], ['CA', 'CA'], ['C', 'C'], ['O', 'O'], [
            'CB', 'CB'], ['CG1'], ['CG2', 'CG2'], ['CD1'], ['OG1']]
        # print('expected \n',expected)
        #
    ...
    def test_2AAD_resnames(self):
        ...
        # print('result \n',result)
        #
        expected = [['ILE', 'ILE', 'ILE', 'ILE', 'ILE', 'ILE', 'ILE', 'ILE'], [
    ...
    def test_2AAD_resids(self):
        ...
        # print('result \n',result)
        #
        expected = [[515, 515, 515, 515, 515, 515, 515, 515],
    ...
    def test_2AAD_occupancies(self):
        ...
        # print('result \n',result)
        #
        expected = [['1.00', '1.00', '1.00', '1.00', '1.00', '1.00', '1.00',
    ...
    def test_2AAD_betas(self):
        ...
        # print('result \n',result)
        #
        expected = [['36.37'], ['36.23'], ['36.32'], ['36.04'], ['36.69'], ['38.12'], ['34.42'], [
            '39.85'], ['35.01'], ['35.51'], ['38.09'], ['36.94'], ['36.74'], ['37.19'], ['34.44']]
        # print('expected \n',expected)
        #
        self.assertEqual(expected, result)
    ...
    def test_rna(self):
        ...
        self.assertEqual(sum([sum(item.resid())
                         for item in result_child]), 118880)
