...
class Test_unit_operate_Move_translate(unittest.TestCase):
    ...
    def test_two_atoms_about_X_axis(self):
        ...
        self.o.setCoor(numpy.array(
            [[[-1.0, 2.0, 3.87], [-5.0, 3.2, 6.0]]], floattype))
        axis = 'x'
        theta = util.num_to_floattype(90.0*numpy.pi/180.0, floattype)
        frame = 0
        #
        expected_coor = numpy.array(
            [[[-1.0, -3.87, 2.0], [-5.0, -6.0, 3.2]]], floattype)[frame]
        #
        self.o.rotate(frame, axis, theta)
        result_coor = self.o.coor()[frame]
        #
    ...
    def test_two_atoms_about_Y_axis(self):
        ...
        #
        expected_coor = numpy.array(
            [[[3.87, 2.0, 1.0], [6.0, 3.2, 5.0]]], floattype)[frame]
        #
        self.o.rotate(frame, axis, theta)
        result_coor = self.o.coor()[frame]
        #
    ...
    def test_two_atoms_about_Z_axis(self):
        ...
        si = numpy.sin(theta)
        expected_coor = numpy.array(
            [[[-1.0*cs-2.0*si, -1.0*si+2.0*cs, 3.87], [-5.0*cs-3.2*si, -5.0*si+3.2*cs, 6.0]]], floattype)[frame]
        #
        self.o.rotate(frame, axis, theta)
        result_coor = self.o.coor()[frame]
        #
    ...
    def test_six_atoms_about_X_axis(self):
        self.o.setCoor(numpy.array([[[1.2, 2.0, 3.0], [-2.0, 5.0, 6.0], [7.0, 8.0, 9.0], [
        ...
        cs = numpy.cos(theta)
        si = numpy.sin(theta)
        expected_coor = numpy.array([[[1.2, 2.0*cs-3.0*si, 2.0*si+3.0*cs], [-2.0, 5.0*cs-6.0*si, 5.0*si+6.0*cs], [7.0, 8.0*cs-9.0*si, 8.0*si+9.0*cs], [
                                    1.0, 3.0*cs-5.0*si, 3.0*si+5.0*cs], [2.0, 4.0*cs-6.0*si, 4.0*si+6.0*cs], [0.0, 2.0*cs-3.0*si, 2.0*si+3.0*cs]]], floattype)[frame]
        #
        self.o.rotate(frame, axis, theta)
        result_coor = self.o.coor()[frame]
        #
    ...
    def test_six_atoms_about_X_axis_nan(self):
        ...
        cs = numpy.cos(theta)
        si = numpy.sin(theta)
        expected_coor = numpy.array([[[1.2, util.NAN*cs-3.0*si, util.NAN*si+3.0*cs], [-2.0, 5.0*cs-6.0*si, 5.0*si+6.0*cs], [7.0, 8.0*cs-9.0*si, 8.0*si+9.0*cs], [
                                    1.0, 3.0*cs-5.0*si, 3.0*si+5.0*cs], [2.0, 4.0*cs-6.0*si, 4.0*si+6.0*cs], [0.0, 2.0*cs-3.0*si, 2.0*si+3.0*cs]]], floattype)[frame]
        #
        self.o.rotate(frame, axis, theta)
        result_coor = self.o.coor()[frame]
    ...
    def test_six_atoms_about_X_axis_tiny(self):
        self.o.setCoor(numpy.array([[[1.2, util.TINY, 3.0], [-2.0, 5.0, 6.0], [
        ...
        cs = numpy.cos(theta)
        si = numpy.sin(theta)
        expected_coor = numpy.array([[[1.2, util.TINY*cs-3.0*si, util.TINY*si+3.0*cs], [-2.0, 5.0*cs-6.0*si, 5.0*si+6.0*cs], [7.0, 8.0*cs-9.0*si, 8.0*si+9.0*cs], [
                                    1.0, 3.0*cs-5.0*si, 3.0*si+5.0*cs], [2.0, 4.0*cs-6.0*si, 4.0*si+6.0*cs], [0.0, 2.0*cs-3.0*si, 2.0*si+3.0*cs]]], floattype)[frame]
        #
        self.o.rotate(frame, axis, theta)
        result_coor = self.o.coor()[frame]
    ...
    def test_six_atoms_about_X_axis_zero(self):
        self.o.setCoor(numpy.array([[[1.2, util.ZERO, 3.0], [-2.0, 5.0, 6.0], [
                       7.0, 8.0, 9.0], [1.0, 3.0, 5.0], [2.0, 4.0, 6.0], [0.0, 2.0, 3.0]]], floattype))
        axis = 'x'
        theta = util.num_to_floattype(128.0*numpy.pi/180.0, floattype)
        frame = 0
        ...
        cs = numpy.cos(theta)
        si = numpy.sin(theta)
        expected_coor = numpy.array([[[1.2, util.ZERO*cs-3.0*si, util.ZERO*si+3.0*cs], [-2.0, 5.0*cs-6.0*si, 5.0*si+6.0*cs], [7.0, 8.0*cs-9.0*si, 8.0*si+9.0*cs], [
                                    1.0, 3.0*cs-5.0*si, 3.0*si+5.0*cs], [2.0, 4.0*cs-6.0*si, 4.0*si+6.0*cs], [0.0, 2.0*cs-3.0*si, 2.0*si+3.0*cs]]], floattype)[frame]
        #
        self.o.rotate(frame, axis, theta)
        result_coor = self.o.coor()[frame]
